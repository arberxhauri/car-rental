...
export default function EditReservation() {
    ...
    const onSubmit = async (event) => {
        ...
        await axios.put(`http://localhost:8080/api/reservations/update/${reservationId}`, {reservation_id: reservationId,...reservationDto},{
            headers: {
    ...
    const loadReservation = async ()=>{
        const result = await axios.get(`http://localhost:8080/api/reservations/${reservationId}`,
            {
                headers: {
                    'Authorization': storedToken,
                    'Content-Type': 'application/json',
